...
#define VISIT_CONFIG_SETTINGS(visit) \
	...
	visit(DdrawBlackAndWhiteHackHandDecal) \
...
struct CONFIG
{
	...
	bool DdrawBlackAndWhiteHackHandDecal = false;	// To allow RTX Remix to consistently detect the hand decal, we have to replace it with a default texture.
